...
- no-more-mdash/manifest.json — Extension manifest  
- no-more-mdash/content.js — Core replacement logic  
- no-more-mdash/icons/ — Directory for icon assets  
- LICENSE — MIT License  
...
2. Build icons and place them under `no-more-mdash/icons/` (16×16, 48×48, 128×128).  
3. Open `chrome://extensions` in Chrome.  
4. Enable "Developer mode".  
5. Click "Load unpacked" and select the `no-more-mdash/` directory.
...
2. Prepare a ZIP archive of the `no-more-mdash/` folder.
